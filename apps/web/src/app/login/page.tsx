      ...
      <div className="w-full max-w-md">
        <Link href="/" className="block mb-10 text-center">
          <span className="text-3xl font-display">
            ...
            <span className="text-white/40 text-xs ml-2 tracking-[0.3em]">MUEBLES</span>
          </span>
        </Link>

        <div className="rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur p-8">
          <h1 className="text-2xl font-display text-white mb-1">Acceso al panel</h1>
          <p className="text-white/50 text-sm mb-8">Ingresa con tu cuenta de Fetis.</p>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <label className="block">
              ...
              <div className="mt-2 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-white/30 focus:outline-none focus:border-brand-500/60 focus:ring-2 focus:ring-brand-500/15 transition"
            ...
            <label className="block">
              <span className="text-xs uppercase tracking-widest text-white/50">Contraseña</span>
              <div className="mt-2 relative">
